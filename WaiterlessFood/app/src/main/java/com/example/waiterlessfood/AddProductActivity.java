...
public class AddProductActivity extends AppCompatActivity {
    ...
    public void addNewProductClick(View view){
        loadingBar.setTitle("Storing to Database");
...
// Register observers to listen for when the download is done or if it fails
    ...
    private void saveProductIntoDatabase() {
        ...
        ProductDetailRef.child(productRandomKey).updateChildren(productMap)
        .addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    loadingBar.dismiss();
                    Toast.makeText(AddProductActivity.this, "save in DataBase Succesfully...", Toast.LENGTH_SHORT).show();
                    recreate();
                }else {
