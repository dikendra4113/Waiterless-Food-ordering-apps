...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText,profile_email, addressEditText);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView,  final EditText fullNameEditText, final EditText userPhoneEditText,final EditText profile_email, final EditText addressEditText)
    {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    if (dataSnapshot.child("image").exists())
                    {
                        ...
                        //Paper.book().write(image,Prevelents.flag);

                        Picasso.get().load(image).into(profileImageView);
                        Picasso.get().load(image).into(menu_profile);
